...
#define GET_HONEYWELL_DATA				0x76	//上位机发送的请求获取honeywell数据命令
#define SEND_HONEYWELL_DATA				0x77	//下位机发送honweywell采集的数据
#define STOP_GET_HONEYWELL_DATA		0x78	//停止发送数据
...
#define FLASH_RECORD_DATETIME_UPLIMIT	((uint32_t)0x08000000+1024*60)  
#else
